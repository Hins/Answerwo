...
{
	if(getCookie("answerwo_name") == null || getCookie("answerwo_name") == "") {
		window.location.href = "http://prepublish.answerwo.com/q/list";
		return 0;
	}
}
...
{
	if(getCookie("answerwo_name") == null || getCookie("answerwo_name") == "") {
		window.location.href = "http://prepublish.answerwo.com";
	}
}

function Start()
{
	var curnum = document.getElementsByName("curnum")[0];
	if(curnum.value != 20) {
		var form = document.getElementsByName("form")[0];
		form.submit();
	}
...
function Report()
{
	var reportform = document.getElementsByName("reportform")[0];
	
	var score = document.getElementsByName("score")[0];
	var finalscore = document.getElementsByName("finalscore")[0];
	...
	if(score.value != "0") {
		finalscore.value = String(score.value) + String(optionvalue);
	}
	else {
		finalscore.value = String(optionvalue);
	}
	
	var cacheid = document.getElementsByName("cacheid")[0];
	var reportcacheid = document.getElementsByName("reportcacheid")[0];
	reportcacheid.value = cacheid.value;
	reportform.submit();
}
